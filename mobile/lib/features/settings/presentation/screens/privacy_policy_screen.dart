      ...
      body: ListView(
        ...
        children: [
          ...
          const _Section(
            ...
            body: 'Abonelik verilerini reklam, analiz veya pazarlama amacıyla '
          ...
          const _Section(
            title: 'Bildirimler',
            body: 'Yenileme hatırlatmaları cihazında yerel olarak zamanlanır '
                '(flutter_local_notifications); bildirim içeriği cihazından '
                'dışarı gönderilmez.',
          ),
          const _Section(
            title: 'Haklarınız (KVKK)',
            body: '6698 sayılı KVKK kapsamında verilerine erişme, düzeltme ve '
